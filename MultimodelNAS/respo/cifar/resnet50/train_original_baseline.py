...
from create_model_baseline import ResNet, Bottleneck, create_search_space
...
def main_worker(gpu, args):
    ...
    train_image_pipeline = [
        ...
        # tvtransforms.RandomRotation([90,90,180]),
        # ModuleWrapper(tvtransforms.RandomVerticalFlip(p=0.5)),
        # tvtransforms.RandomApply([tvtransforms.RandomRotation((90, 90))], p=0.5),
        ToTensor(),
