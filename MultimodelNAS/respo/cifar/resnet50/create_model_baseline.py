...
class ResNet(nn.Module):
    def __init__(
        ...
        self.bn1 = norm_layer(self.inplanes,track_running_stats=True, affine=True)
        self.relu = nn.ReLU(inplace=True)
...
def create_search_space():
    ...
    print(path_blocks)
    print(len(list(to_sum_k_rec(4, 17))))
    all_paths = []
    for p in path_blocks:
        ...
        binary_new_block = [1 if i in cul_new_index else 0 for i in range(1, 17)]
