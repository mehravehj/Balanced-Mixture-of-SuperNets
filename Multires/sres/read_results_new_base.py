...
def plotting(test_name, in_epoch=0, factor=1, pro=0, test_5=0, test_6=0, pool=0):
    ...
    # pool = test_properties['pool']
    # pool = string_to_list(pool)
    ...
    prop = accuracy_progress
    test_title = 'test ' + str(8738) +  '\n' + test_properties['dataset'] + ', ' + 'sres'  + '\n tr: ' + str(99.34) + ', val: ' + str(92.05) + ', test: ' + str(91.74) + '\n epoch ' + str(985) + '/' + str(1000)
