...
def main():
    ...
    for layer in range(0,10):
        ...
        for counter in range(1, 6):
            l = layer
            net.module.layer[l].block.remove = counter
            print('epoch ', epoch)
            ...
            res_performances.append(test_accuracy)
        most_impacful_res = min(res_performances)
        keep_res = res_performances.index(most_impacful_res)
        print('keeping resolution ', most_impacful_res)
